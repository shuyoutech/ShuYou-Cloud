...
@AutoMapper(target = PayNotifyRecordVo.class)
@Document(collection = "pay_notify_record")
@Schema(description = "支付通知记录表类")
public class PayNotifyRecordEntity extends BaseEntity<PayNotifyRecordEntity> {
