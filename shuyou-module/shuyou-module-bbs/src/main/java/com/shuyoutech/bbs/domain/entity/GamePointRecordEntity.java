...
@AutoMapper(target = GamePointRecordVo.class)
@Document(collection = "bbs_game_point_record")
@Schema(description = "游戏积分记录表类")
public class GamePointRecordEntity extends BaseEntity<GamePointRecordEntity> {
