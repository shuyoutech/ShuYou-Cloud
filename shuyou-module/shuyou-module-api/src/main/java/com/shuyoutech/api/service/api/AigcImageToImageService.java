...
import static com.shuyoutech.api.enums.InterfaceFunctionEnum.AIGC_IMAGE_TO_IMAGE;
...
public class AigcImageToImageService implements ApiService {

    @Override
    public String interfaceName() {
        return AIGC_IMAGE_TO_IMAGE.getValue();
    }
    ...
    public void execute(JSONObject params, HttpServletResponse response) {
        ...
        modelProvider.imageToImage(model.getBaseUrl(), model.getApiKey(), params, response);
    }
