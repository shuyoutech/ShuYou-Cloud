...
import static com.shuyoutech.api.enums.InterfaceFunctionEnum.AIGC_AUDIO_SPEECH;
...
public class AigcAudioSpeechService implements ApiService {
    ...
    public String interfaceName() {
        return AIGC_AUDIO_SPEECH.getValue();
    }
    ...
    public void execute(JSONObject params, HttpServletResponse response) {
        ...
        modelProvider.audioSpeech(model.getBaseUrl(), model.getApiKey(), params, response);
    }
