...
import static com.shuyoutech.api.enums.InterfaceFunctionEnum.AIGC_BETA_COMPLETION;
...
public class AigcBetaCompletionService implements ApiService {
    ...
    public String interfaceName() {
        return AIGC_BETA_COMPLETION.getValue();
    }
    ...
    public void execute(JSONObject params, HttpServletResponse response) {
        ...
        modelProvider.betaCompletion(model.getBaseUrl(), model.getApiKey(), params, response);
    }
