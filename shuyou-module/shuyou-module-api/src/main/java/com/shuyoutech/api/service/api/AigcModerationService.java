...
public class AigcModerationService implements ApiService {

    @Override
    public String interfaceName() {
        return "aigcModeration";
    }
    ...
    public void execute(JSONObject params, HttpServletResponse response) {
        ...
        modelProvider.moderation(model.getBaseUrl(), model.getApiKey(), params, response);
    }
